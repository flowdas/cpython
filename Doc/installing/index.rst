...
``pip``::
   ...
   python2.7 -m pip install SomePackage  # 구체적으로 파이썬 2.7
   python3   -m pip install SomePackage  # 기본 파이썬 3
   python3.4 -m pip install SomePackage  # 구체적으로 파이썬 3.4
...
switch::
   ...
   py -2.7 -m pip install SomePackage  # 구체적으로 파이썬 2.7
   py -3   -m pip install SomePackage  # 기본 파이썬 3
   py -3.4 -m pip install SomePackage  # 구체적으로 파이썬 3.4
